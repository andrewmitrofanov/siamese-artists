...
Основная цель triplet loss - сформировать такое векторное пространство, в котором вектора, полученные на основе изображений одного класса, располагались близко друг к другу, а полученные на основе изображений разных классов - далеко друг от друга.

В качетвенно сформированном пространстве вектора разных классов будут образовывать чётко различимые кластеры.
